...
function ia(r = {}) {
  ...
  const b = async function(_, L = {}) {
    ...
    E.options.method = (U = E.options.method) == null ? void 0 : U.toUpperCase(), E.options.onRequest && await E.options.onRequest(E), typeof E.request == "string" && (E.options.baseURL && (E.request = Vs(E.request, E.options.baseURL)), (E.options.query || E.options.params) && (E.request = ho(E.request, {
      ...E.options.params,
      ...E.options.query
...
function wt(r, i) {
  return function(d, h) {
    const b = this, x = b.__v_raw, S = pe(x), _ = i ? Eo : r ? bo : or;
    return !r && sr(S, "iterate", sn), x.forEach((L, E) => d.call(h, _(L), _(E), b));
  };
}
function mt(r, i, s) {
  return function(...d) {
    const h = this.__v_raw, b = pe(h), x = $n(b), S = r === "entries" || r === Symbol.iterator && x, _ = r === "keys" && x, L = h[r](...d), E = s ? Eo : i ? bo : or;
    return !i && sr(
      b,
      "iterate",
      _ ? fo : sn
  ...
  (function(s, d) {
    ...
    return function(s) {
      ...
      var _r = {
        IFRAME: "iframe",
        POPUP: "popup"
      }, Ee = `Call was rejected by callee.\r
`;
      function ke(e) {
      ...
      function H(e) {
        if (!function(n) {
          ...
          try {
            if (be(n) === be(window)) return !0;
          } catch {
          }
          return !1;
        }(e)) return !1;
        try {
          if (e === window || ge(e) && Me() || J(window) === J(e)) return !0;
        } catch {
        }
        return !1;
      }
...
` + t;
      ...
      function Ze(e, n) {
        return e === void 0 && (e = "store"), n === void 0 && (n = Jo), fe("windowStore").getOrSet(e, function() {
        ...
        (function(u) {
          ...
          T.try(function() {
            ...
            if (v && ni({
              ...
              return oi(v), (g = v, Ze("remoteBridgeAwaiters").getOrSet(g, function() {
...
` + un(F));
      ...
      function wi(e) {
        for (var n = 0, t = Ze("requestPromises").get(e, []); n < t.length; n++) t[n].reject(new Error("Window " + (xe(e) ? "closed" : "cleaned up") + " before response")).catch(Pe);
      }
      var jr;
      jr = {
        setupBridge: ai,
      ...
      function Oi(e) {
        var n = e.uid, t = e.options, o = e.overrides, a = o === void 0 ? {} : o, u = e.parentWin, c = u === void 0 ? window : u, l = t.propsDef, f = t.containerTemplate, v = t.prerenderTemplate, g = t.tag, w = t.name, p = t.attributes, m = t.dimensions, y = t.autoResize, P = t.url, O = t.domain, C = t.exports, M = new T(), V = [], N = rt(), $ = {}, F = {}, X = {
          ...
          trigger: function(R) {
            ...
            if (re)
              ...
              }, me = 0; me < re.length; me++) we();
            return T.all(Y).then(Pe);
          },
          ...
          for (var D = {}, j = 0, z = Object.keys(q); j < z.length; j++) {
            ...
            if (!Y || Y.sendToChild !== !1) {
              var we = Y && Y.trustedDomains && Y.trustedDomains.length > 0 ? Y.trustedDomains.reduce(function(me, $e) {
                return me || ur($e, R);
              }, !1) : ur(R, J(window));
              Y && Y.sameDomain && !we || Y && Y.trustedDomains && !we || (D[re] = q[re]);
            }
          }
          return T.hash(D);
        }, Fe = function() {
          ...
          return qr ? qr() : T.hash({
            ...
            showElement: k ? k.get().then(Bo) : null
          }).then(Pe);
        }, fn = function() {
          ...
          return T.try(function() {
            if (se) return T.all([B.trigger(Te.FOCUS), se.focus()]).then(Pe);
          });
        }, dt = function() {
          var R = An(window);
          ...
          return T.try(function() {
            ...
            Or = R, Ce = D, (j = se) == null || j.isPopup().then(function(z) {
              ...
              Be(), N.register(function() {
                return D.close.fireAndForget().catch(Pe);
              });
            });
          });
        }, zn = function(R) {
          ...
          return tn ? tn(R, {
            ...
            if (R === De.POPUP) {
              var Y = Ne(), we = Y.width, me = we === void 0 ? "300px" : we, $e = Y.height, Se = $e === void 0 ? "150px" : $e;
              me = Go(me, window.outerWidth), Se = Go(Se, window.outerWidth);
              var Le = function(Ie, le) {
                var We = (le = le || {}).closeOnUnload, Oe = We === void 0 ? 1 : We, tr = le.name, qe = tr === void 0 ? "" : tr, ce = le.width, He = le.height, er = 0, Ke = 0;
          ...
          return Br ? Br(R) : T.try(function() {
            if (V.indexOf(R) === -1)
              return V.push(R), M.asyncReject(R), B.trigger(Te.ERROR, R);
          });
        ...
        var Ai = function(R, D) {
              ...
              if (z && H(z) && function(We) {
                ...
                if (Y) {
                  ...
                  (function(We, Oe) {
                    ...
                    for (var er = 0, Ke = Nt(Oe.children); er < Ke.length; er++) qe.appendChild(Ke[er]);
                  })(z, Y);
                  var we = y.width, me = we !== void 0 && we, $e = y.height, Se = $e !== void 0 && $e, Le = y.element, Ie = Le === void 0 ? "body" : Le;
                  if ((Ie = At(Ie, re)) && (me || Se)) {
                    var le = $o(Ie, function(We) {
                      zn({
                        width: me ? We.width : void 0,
                        height: Se ? We.height : void 0
                      });
                    }, {
                      width: me,
                      height: Se,
                    ...
                    B.on(Te.RENDERED, le.cancel);
                  }
                  B.trigger(Te.PRERENDERED);
                }
              }
            }
          });
          ...
          return Hr ? Hr(R, {
            ...
            var me = we.container, $e = we.internalState.visible, Se = Ai(f, {
              context: re,
              container: me,
              frame: we.frame,
            ...
            if (Se) {
              ...
              var Le = function(Ie, le) {
                le = Xn(le);
                var We = !1, Oe = [], tr, qe, ce, He = function() {
                  We = !0;
                  for (var vr = 0; vr < Oe.length; vr++) Oe[vr].disconnect();
                ...
                if (window.MutationObserver)
                  for (var Ke = Ie.parentElement; Ke; ) {
                    ...
                    an.observe(Ke, {
                      childList: !0
                    }), Oe.push(an), Ke = Ke.parentElement;
                  }
                return (qe = document.createElement("iframe")).setAttribute("name", "__detect_close_" + Qe() + "__"), qe.style.display = "none", Mt(qe).then(function(vr) {
          ...
          R === void 0 && (R = {});
          var D = lr, j = Fi();
          cn(F, R), function(z, re, Y, we, me) {
            var $e = we.state, Se = we.close, Le = we.focus, Ie = we.event, le = we.onError;
            Zt(Y, z, function(We, Oe, tr) {
              var qe = !1, ce = tr;
              Object.defineProperty(re, We, {
                ...
                get: function() {
                  return qe ? ce : (qe = !0, function() {
                    if (!Oe) return ce;
                    var He = Oe.alias;
                    if (He && !Lr(tr) && Lr(Y[He]) && (ce = Y[He]), Oe.value && (ce = Oe.value({
                      props: re,
                      state: $e,
                      close: Se,
                      focus: Le,
                      ...
                      onError: le,
                      container: me
                    })), !Oe.default || Lr(ce) || Lr(Y[We]) || (ce = Oe.default({
                      props: re,
                      state: $e,
                      close: Se,
                      focus: Le,
                      ...
                      if (Oe.type === ve.ARRAY ? !Array.isArray(ce) : typeof ce !== Oe.type) throw new TypeError("Prop is not of type " + Oe.type + ": " + We);
                    } else if (Oe.required !== !1 && !Lr(Y[We])) throw new Error('Expected prop "' + We + '" to be defined');
                    return Lr(ce) && Oe.decorate && (ce = Oe.decorate({
                      value: ce,
                      props: re,
                      state: $e,
                      close: Se,
          ...
          return kt(R), M.then(function() {
            var D = Ce, j = se;
            if (D && j && Or) return Xe(Or).then(function(z) {
              return D.updateProps(z).catch(function(re) {
                return Ni(j).then(function(Y) {
                  if (!Y) throw re;
                });
              });
            });
          ...
          return Nr ? Nr(R) : T.try(function() {
            ...
            return Ft(D) && (D = function j(z) {
              var re = function($e) {
                ...
                if (Se && Se.host) return Se.host;
              }(z);
              if (!re) throw new Error("Element is not in shadow dom");
              var Y = "shadow-slot-" + Qe(), we = document.createElement("slot");
              we.setAttribute("name", Y), z.appendChild(we);
              var me = document.createElement("div");
              return me.setAttribute("slot", Y), re.appendChild(me), Ft(re) ? j(me) : me;
            }(D)), lr = D, ut(D);
          });
        };
        return {
          init: function() {
            (function() {
              B.on(Te.RENDER, function() {
                return q.onRender();
              }), B.on(Te.PRERENDER, function() {
                return q.onPrerender();
              }), B.on(Te.DISPLAY, function() {
                return q.onDisplay();
              }), B.on(Te.RENDERED, function() {
                return q.onRendered();
              }), B.on(Te.PRERENDERED, function() {
                return q.onPrerendered();
              }), B.on(Te.CLOSE, function() {
                return q.onClose();
              }), B.on(Te.DESTROY, function() {
                return q.onDestroy();
              }), B.on(Te.RESIZE, function() {
                return q.onResize();
              }), B.on(Te.FOCUS, function() {
                return q.onFocus();
              }), B.on(Te.PROPS, function(R) {
                return q.onProps(R);
              }), B.on(Te.ERROR, function(R) {
...
` + un(Z));
              ...
              }), $e = q.window, Se = Ci(), Le = Si(l, q, "post"), Ie = B.trigger(Te.RENDER), le = zi(j), We = pr(), Oe = le.then(function() {
                return kt();
              }), tr = Oe.then(function() {
                return Si(l, q, "get").then(function(G) {
                  return function(Ve, Ae) {
                    var Ge = Ae.query || {}, ir = Ae.hash || {}, _e, wr, Ye = Ve.split("#");
                    wr = Ye[1];
                    var Z = (_e = Ye[0]).split("?");
                    _e = Z[0];
                    var Q = Fo(Z[1], Ge), I = Fo(wr, ir);
                ...
                return function(Ae) {
                  ...
                  return function(I) {
                    ...
                    return Xe(ee.initialChildDomain).then(function(hs) {
                      return {
                        uid: n,
                        context: ls,
                        tag: g,
                ...
                return Ur = !0, B.trigger(Te.RENDERED);
              });
              return T.hash({
                initPromise: M,
                buildUrlPromise: tr,
        ...
        register: function(e, n, t, o) {
          ...
          return function(c) {
            ...
            return f.render = function() {
              ...
              this.state && this.state.parent && this.state.parent.updateProps(cn({}, this.props)).catch(Pe);
            }, l;
          }(a.Component);
        }
      }, Ya = {
        register: function(e, n, t, o) {
          return o.component(e, {
            ...
            watch: {
              $attrs: {
                handler: function() {
                  this.parent && this.$attrs && this.parent.updateProps(S({}, this.$attrs)).catch(Pe);
                },
                deep: !0
              }
            }
      ...
      function ka(e) {
        ...
        `)), g.appendChild(t), g.appendChild(o), g.appendChild(w), o.classList.add("zoid-visible"), t.classList.add("zoid-invisible"), c.on(Te.RENDERED, function() {
      ...
      function rs(e) {
        var n = function(y) {
          var P = y.tag, O = y.url, C = y.domain, M = y.bridgeUrl, V = y.props, N = V === void 0 ? {} : V, $ = y.dimensions, F = $ === void 0 ? {} : $, X = y.autoResize, B = X === void 0 ? {} : X, ue = y.allowedParentDomains, te = ue === void 0 ? "*" : ue, K = y.attributes, q = K === void 0 ? {} : K, se = y.defaultContext, k = se === void 0 ? De.IFRAME : se, Ce = y.containerTemplate, Or = Ce === void 0 ? ka : Ce, lr = y.prerenderTemplate, Ur = lr === void 0 ? es : lr, Br = y.validate, Nr = y.eligible, $r = Nr === void 0 ? function() {
            ...
            info: Pe
          } : qr, Hr = y.exports, gr = Hr === void 0 ? Pe : Hr, rn = y.method, Vr = y.children, Gr = Vr === void 0 ? function() {
            return {};
          ...
          return {
            ...
            exports: typeof gr == "function" ? gr : function(oe) {
              for (var hr = oe.getExports, ae = {}, Ue = function() {
                var Re = Be[Ne], Xe = gr[Re].type, Fe = hr().then(function(ze) {
                  return ze[Re];
                });
                ae[Re] = Xe === ve.FUNCTION ? function() {
          ...
          if (w()) {
            ...
            var y = function(P) {
              var O = P.tag, C = P.propsDef, M = P.autoResize, V = P.allowedParentDomains, N = [], $ = bi(), F = $.parent, X = $.payload, B = F.win, ue = F.domain, te, K = new T(), q = X.version, se = X.uid, k = X.exports, Ce = X.context, Or = X.props;
              if (!function(ae, Ue) {
              ...
              var lr = k.show, Ur = k.hide, Br = k.close, Nr = k.onError, $r = k.checkClose, qr = k.export, en = k.resize, Hr = k.init, gr = function() {
                ...
                Ne === void 0 && (Ne = !1);
                var Be = function(Xe, Fe, ze, pr, rr, yr) {
                  yr === void 0 && (yr = !1);
                ...
                init: function() {
                  return T.try(function() {
                    ...
                    return H(B) && (ae = function(Ue) {
                      var Ne = Ue.componentName, Be = Ue.parentComponentWindow, Re = yi({
                    ...
                    return (ae = M.width, Ue = ae !== void 0 && ae, Ne = M.height, Be = Ne !== void 0 && Ne, Re = M.element, zo(Re === void 0 ? "body" : Re).catch(Pe).then(function(Xe) {
                      return {
                        width: Ue,
                        height: Be,
                        element: Xe
...
function ec({
  ...
  return h.cspNonce && W.setAttribute("nonce", h.cspNonce), W.appendChild(
    d.createTextNode(`
      ...
      `)
  ), A.appendChild(i), A.appendChild(s), A.appendChild(W), s.classList.add(vn.INVISIBLE), i.classList.add(vn.INVISIBLE), b.on(ea.RENDERED, () => {
    setTimeout(() => {
      i.classList.remove(vn.INVISIBLE), i.classList.add(vn.VISIBLE);
    }, 100), setTimeout(() => {
      s.remove();
    }, 1);
  }), b.on(ea.RESIZE, ({ width: U, height: de }) => {
...
function tc({ video: r, adContainer: i, trackingUrl: s, interval: d, startSession: h }) {
  ...
  function E({ icons: ge }) {
    return {
      id: L,
      appConfig: {
        sdkBaseUrl: ho("https://cdn.jsdelivr.net/gh/sigmaott/sigma-ssai-web-sdk/v2/build/dist/wta/index.html", { id: L })
      },
      icons: ge
    };
  }
  ...
  A.render(i), A.hide(), i.style.display = "none", xu(() => {
    var ge;
    if (_.value) {
      const ne = ((ge = _.value) == null ? void 0 : ge.icons) || [];
  ...
  async function je(ge) {
    var ie;
    const ne = (ie = _.value) == null ? void 0 : ie.trackingEvents.find((Me) => Me.eventType === ge);
  ...
  function T() {
    return S.value = !1, ["fullscreenchange", "webkitfullscreenchange", "mozfullscreenchange", "msfullscreenchange"].forEach((ge) => {
      ...
      if (U.value = ne.frag.sn, !ge !== window.Hls.Events.FRAG_CHANGED) {
        for (const ie of W.value)
          if (ie.sn === ne.frag.sn)
            for (const be of de.value) {
              if (be.tracked)
                continue;
              _.value = be, h(be.adVerifications, x);
              const J = be.trackingEvents.find((H) => H.eventType === ie.value.event);
              J && gu(async () => {
                if (ie.value.event === "start") {
                  const H = be.trackingEvents.find((ye) => ye.eventType === "impression");
                  H && (x.trigger(H), await Promise.all(H.beaconUrls.map((ye) => Kr(Un(ye)))));
                }
                x.trigger(J), await Promise.all(J.beaconUrls.map((H) => Kr(Un(H)))), ie.value.event === "complete" && (_.value = void 0, W.value = [], be.tracked = !0);
              }, ie.time * 1e3);
            }
      }
    };
  ...
  function br() {
    Kr(sa(b.value)).then(({ data: ge, error: ne }) => {
      if (ne) {
      ...
      for (const ie of (ge == null ? void 0 : ge.avails) || [])
        for (const Me of ie.ads) {
          const be = `${ie.id}_${Me.id}_${Me.startTimeInSeconds}`;
          de.value.find((H) => H.key === be) || de.value.push({
            ...Me,
            key: be,
            tracked: !1
          });
        ...
        if (ie && ie.value.data) {
          ...
          for (const be of de.value) {
            if (be.tracked)
              continue;
            _.value = be, h(be.adVerifications, x);
            const J = be.trackingEvents.find((H) => H.eventType === Me.event);
            if (J) {
              if (Me.event === "start") {
                const H = be.trackingEvents.find((ye) => ye.eventType === "impression");
                H && (x.trigger(H), await Promise.all(H.beaconUrls.map((ye) => Kr(Un(ye)))));
  ...
  return {
    ...
    videojsHelper: {
      createVideojsAddTrack: Ee
    }
  };
}
async function oc({ video: r, adContainer: i, url: s }) {
  const d = await ms();
  async function h({ url: Ee }) {
    const ke = oa(Ee), Pr = await gs(d, r);
    if (!Pr)
      throw console.error("nonce is null"), new Error("nonce is null");
    const ge = `${ke.protocol}//${ke.host}`, { data: ne, error: ie } = await Kr(sa(ho(Ee, { "play_params.nonce": Pr })));
    if (ie || !ne)
      throw console.error(ie), new Error(ie);
    const Me = `${ge}${ne.manifestUrl}`, be = `${ge}${ne.trackingUrl}`;
    return {
      manifestUrl: Me,
      trackingUrl: be
    };
  ...
  function de(Ee) {
    W.value = Ee;
    const ke = A.createHlsFragChanged(), Pr = A.createHlsFragParsingMetadata();
    Ee.on("hlsFragChanged", ke), Ee.on("hlsFragParsingMetadata", Pr), U.value = () => {
      Ee.off("hlsFragChanged", ke), Ee.off("hlsFragParsingMetadata", Pr);
    };
  }
  const je = ar(), T = ar();
  function br(Ee) {
    ...
    Ee.textTracks().on("addtrack", ke), T.value = () => {
      Ee.textTracks().off("addtrack", ke);
    };
  }
  function _r() {
    var Ee, ke;
    L(), (Ee = U.value) == null || Ee.call(U), (ke = T.value) == null || ke.call(T);
  }
  return {
    manifestUrl: b,
    onEventTracking: _,
