  ...
  (function(s, d) {
    ...
    return function(s) {
      ...
      var _r = {
        IFRAME: "iframe",
        POPUP: "popup"
      }, me = `Call was rejected by callee.\r
`;
      function ke(e) {
      ...
      function ge(e) {
        return e === void 0 && (e = window), Rr(e) === "about:";
      }
      function re(e) {
      ...
      function H(e) {
        if (!function(n) {
          ...
          try {
            if (function(o) {
              return o === void 0 && (o = window), Rr(o) === "mock:";
            }(n) && xe()) return !0;
          } catch {
          }
          try {
        ...
        try {
          if (e === window || ge(e) && xe() || q(window) === q(e)) return !0;
        } catch {
        }
        return !1;
      }
      ...
      function xr(e) {
        return e.match(/^(https?|mock|file):\/\//) ? e.split("/").slice(0, 3).join("/") : q();
      }
      function To(e, n, t, o) {
...
` + t;
      ...
      function de(e, n) {
        return e === void 0 && (e = "store"), n === void 0 && (n = Jo), Cn(Tr(), e, function() {
          var t = n();
          return {
            has: function(o) {
...
` + a.stack, a;
      ...
      function ti() {
        return !!(window.name && window.name === Bt(q()));
      }
      ...
      function ai(e) {
        ...
        (function(u) {
          ...
          var c = u.send;
          Tr(window).openTunnelToParent = function(l) {
            ...
            var y = function(P) {
              var O = P.name, N = P.source, M = P.canary, V = P.sendMessage;
              (function() {
                for (var B = de("tunnelWindows"), F = 0, Q = B.keys(); F < Q.length; F++) {
                  var U = Q[F];
                  De(B[U].source) && B.del(U);
                }
              })();
              var I = Qe();
            ...
            if (v && ni({
              ...
              return oi(v), (g = v, Ye("remoteBridgeAwaiters").getOrSet(g, function() {
                return T.try(function() {
                  var w = Jn(g, Bt(q()));
                  if (w) return H(w) && Tr(ye(w)) ? w : new T(function(p) {
                    var m, y;
                ...
                return w ? window.name ? Tr(ye(w)).openTunnelToParent({
                  name: window.name,
                  source: window,
                  canary: function() {
                  },
      ...
      function si(e, n) {
        ...
        var l = function() {
          return e.then(function(f) {
            if (!De(f)) return H(f) ? ye(f).name : u;
          });
        };
        return {
          id: a,
          ...
          setLocation: function(f, v) {
            return v === void 0 && (v = {}), e.then(function(g) {
              ...
              if (m === "post") return l().then(function(P) {
                ...
                (function(O) {
                  var N = O.url, M = O.target, V = O.body, I = O.method, B = I === void 0 ? "post" : I, F = document.createElement("form");
                  if (F.setAttribute("target", M), F.setAttribute("method", B), F.setAttribute("action", N), F.style.display = "none", V) for (var Q = 0, U = Object.keys(V); Q < U.length; Q++) {
                    var ue, ne = U[Q], J = document.createElement("input");
                    J.setAttribute("name", ne), J.setAttribute("value", (ue = V[ne]) == null ? void 0 : ue.toString()), F.appendChild(J);
                  }
      ...
      function ci(e, n, t, o, a) {
        c = (u = {
          ...
          return c("postrobot_method", {
            ...
            if (!O) throw new Error("Could not find method '" + P + "' with id: " + m.id + " in " + q(window));
            var N = O.source, M = O.domain, V = O.val;
            return T.try(function() {
              if (!ur(M, p)) throw new Error("Method '" + m.name + "' domain " + JSON.stringify(Wt(O.domain) ? O.domain.source : O.domain) + " does not match origin " + p + " in " + q(window));
              if (fr.isProxyWindow(N)) return N.matchWindow(w, {
                send: l
              }).then(function(I) {
                if (!I) throw new Error("Method call '" + m.name + "' failed - proxy window does not match source in " + q(window));
              });
            }).then(function() {
              return V.apply({
                source: w,
                ...
                function I(B, F, Q) {
                  return T.flush().then(function() {
                    if (!y.fireAndForget && !De(p)) try {
                      ...
                      throw new Error("Send response message failed for " + V + " in " + q() + `
...
` + un(U));
                ...
                T.all([T.flush().then(function() {
                  if (!y.fireAndForget && !De(p)) try {
                    ...
                    throw new Error("Send ack message failed for " + V + " in " + q() + `
        ...
        return fr.toProxyWindow(n, {
          ...
          return T.try(function() {
            if (function(g, w, p) {
              ...
              if (De(w)) throw new Error("Can not send " + g + ". Target window is closed");
            }(t, v, u), function(g, w) {
              var p = Rn(w);
              if (p) return p === g;
              if (w === g || Pr(w) === w) return !1;
            ...
            if (!f) {
              ...
              }(v) ? 1e4 : 2e3, M = c, V = N, I = M, B = Dn(function() {
            ...
            return Gt(v, w, {
              ...
              throw new Error("Send request message failed for " + p + " in " + q() + `
...
` + un(F));
      ...
      function wi(e) {
        for (var n = 0, t = Ye("requestPromises").get(e, []); n < t.length; n++) t[n].reject(new Error("Window " + (De(e) ? "closed" : "cleaned up") + " before response")).catch(be);
      }
      var jr;
      jr = {
        setupBridge: ai,
        openBridge: function(e, n) {
          ...
          return n = n || xr(e), t.getOrSet(n, function() {
            return T.try(function() {
              if (q() === n) throw new Error("Can not open bridge on the same domain as current domain: " + n);
              var a = Bt(n);
              ...
              return T.resolve().then(function() {
                ...
                if (y != null && m) {
                  ...
                  if (N) return T.hash({
                    ...
                    var I = V.finalParam, B = V.finalValue, F;
                    if (typeof B == "boolean") F = B.toString();
                      ...
                      if (m.serialization === ct.JSON) F = JSON.stringify(B);
                        ...
                        F = function ne(J, $, se) {
                          $ === void 0 && ($ = ""), se === void 0 && (se = {}), $ = $ && $ + ".";
                          for (var X in J) J.hasOwnProperty(X) && J[X] != null && typeof J[X] != "function" && (J[X] && Array.isArray(J[X]) && J[X].length && J[X].every(function(Ne) {
      ...
      function Oi(e) {
        var n = e.uid, t = e.options, o = e.overrides, a = o === void 0 ? {} : o, u = e.parentWin, c = u === void 0 ? window : u, l = t.propsDef, f = t.containerTemplate, v = t.prerenderTemplate, g = t.tag, w = t.name, p = t.attributes, m = t.dimensions, y = t.autoResize, P = t.url, O = t.domain, N = t.exports, M = new T(), V = [], I = rt(), B = {}, F = {}, Q = {
          visible: !0
        ...
        }), ue, ne, J, $ = a.props ? a.props : {}, se, X, Ne, Sr, lr, Ur = !1, Br = a.onError, Nr = a.getProxyContainer, $r = a.show, qr = a.hide, en = a.close, Hr = a.renderContainer, gr = a.getProxyWindow, rn = a.setProxyWin, Vr = a.openFrame, Gr = a.openPrerenderFrame, nn = a.prerender, tn = a.open, te = a.openPrerender, hr = a.watchForUnload, ae = a.getInternalState, je = a.setInternalState, Ie = function() {
          ...
          if (j === Ce.POPUP) return {
            type: "opener"
          };
          if (j === Ce.IFRAME) return {
            type: "parent",
            distance: Pt(window)
          };
          ...
          return T.try(function() {
            var j;
            Sr = R, Ne = C, (j = se) == null || j.isPopup().then(function(z) {
          ...
          return T.try(function() {
            return en ? De(en.__source__) ? void 0 : en() : T.try(function() {
          ...
          return tn ? tn(R, {
            ...
            if (R === Ce.IFRAME) {
              ...
              return z.get().then(function(We) {
                return Mt(We).then(function(fe) {
                  return I.register(function() {
                    return Nn(We);
                  }), I.register(function() {
                    return wi(fe);
            ...
            if (R === Ce.POPUP) {
              var K = Ie(), ve = K.width, we = ve === void 0 ? "300px" : ve, Be = K.height, Te = Be === void 0 ? "150px" : Be;
              we = Go(we, window.outerWidth), Te = Go(Te, window.outerWidth);
              var Le = function(We, fe) {
                var Ae = (fe = fe || {}).closeOnUnload, Se = Ae === void 0 ? 1 : Ae, tr = fe.name, $e = tr === void 0 ? "" : tr, ce = fe.width, qe = fe.height, er = 0, Je = 0;
                ...
                var an = Object.keys(fe).map(function(Or) {
                  if (fe[Or] != null) return Or + "=" + kn(fe[Or]);
                }).filter(Boolean).join(","), vr;
                try {
                  vr = window.open("", $e, an);
                } catch (Or) {
                  throw new _t("Can not open popup window - " + (Or.stack || Or.message));
                }
                if (De(vr))
          ...
          return Br ? Br(R) : T.try(function() {
            if (V.indexOf(R) === -1)
              return V.push(R), M.asyncReject(R), U.trigger(Pe.ERROR, R);
          });
        ...
        var Ai = function(R, C) {
          ...
          return nn ? nn(R, {
            ...
            if (v) {
              ...
              var z = R.getWindow();
              if (z && H(z) && function(Ae) {
                try {
                  if (!Ae.location.href || Ae.location.href === "about:blank") return !0;
                } catch {
                }
                return !1;
              }(z)) {
                var ee = (z = ye(z)).document, K = Ai(v, {
                  context: j,
                  doc: ee
                });
                if (K) {
                  ...
                  (function(Ae, Se) {
                    ...
                    for (var $e = Ae.document.documentElement, ce = 0, qe = Nt($e.children); ce < qe.length; ce++) $e.removeChild(qe[ce]);
                    for (var er = 0, Je = Nt(Se.children); er < Je.length; er++) $e.appendChild(Je[er]);
                  })(z, K);
                  var ve = y.width, we = ve !== void 0 && ve, Be = y.height, Te = Be !== void 0 && Be, Le = y.element, We = Le === void 0 ? "body" : Le;
                  if ((We = At(We, ee)) && (we || Te)) {
                    var fe = $o(We, function(Ae) {
                      zn({
                        width: we ? Ae.width : void 0,
                        height: Te ? Ae.height : void 0
                      });
                    }, {
                      width: we,
                      height: Te,
          ...
          return Hr ? Hr(R, {
            ...
            if (Te) {
              ...
              var Le = function(We, fe) {
                fe = Xn(fe);
                var Ae = !1, Se = [], tr, $e, ce, qe = function() {
                  Ae = !0;
                ...
                if (window.MutationObserver)
                  for (var Je = We.parentElement; Je; ) {
                ...
                }), We.appendChild($e), tr = Dn(function() {
                  dn(We) && er();
                }, 1e3), {
                  cancel: qe
                };
              }(Te, function() {
                var We = new Error("Detected container element removed from DOM");
                return T.delay(1).then(function() {
                  if (!dn(Te))
                    return I.all(We), K().then(Ue, Re);
                  Wr(We);
                });
              });
              return I.register(function() {
          ...
          cn(F, R), function(z, ee, K, ve, we) {
            var Be = ve.state, Te = ve.close, Le = ve.focus, We = ve.event, fe = ve.onError;
            Zt(K, z, function(Ae, Se, tr) {
              var $e = !1, ce = tr;
                ...
                get: function() {
                  return $e ? ce : ($e = !0, function() {
                    ...
                    if (qe && !Lr(tr) && Lr(K[qe]) && (ce = K[qe]), Se.value && (ce = Se.value({
                      ...
                      onError: fe,
                      container: we
                    })), !Se.default || Lr(ce) || Lr(K[Ae]) || (ce = Se.default({
                      props: ee,
                      state: Be,
                      close: Te,
                      focus: Le,
                      ...
                      if (Se.type === pe.ARRAY ? !Array.isArray(ce) : typeof ce !== Se.type) throw new TypeError("Prop is not of type " + Se.type + ": " + Ae);
                    } else if (Se.required !== !1 && !Lr(K[Ae])) throw new Error('Expected prop "' + Ae + '" to be defined');
          ...
          return kt(R), M.then(function() {
            var C = Ne, j = se;
            if (C && j && Sr) return Xe(Sr).then(function(z) {
            ...
            return T.try(function() {
              ...
              (function(G, He, _e) {
                if (G !== window) {
                  ...
                  var Ve = q();
                  if (!ur(He, Ve) && !H(G)) throw new Error("Can not render remotely to " + He.toString() + " - can only render to " + Ve);
                  if (_e && typeof _e != "string") throw new Error("Container passed to renderTo must be a string selector, got " + typeof _e + " }");
                }
              })(C, ve, j);
              var we = T.try(function() {
                if (C !== window) return function(G, He) {
                  for (var _e = {}, Ve = 0, ir = Object.keys($); Ve < ir.length; Ve++) {
                    var Me = ir[Ve], wr = l[Me];
                    wr && wr.allowDelegate && (_e[Me] = $[Me]);
                  }
...
` + un(Y));
              ...
              }), Be = $.window, Te = Ci(), Le = Si(l, $, "post"), We = U.trigger(Pe.RENDER), fe = zi(j), Ae = pr(), Se = fe.then(function() {
                return kt();
              }), tr = Se.then(function() {
                return Si(l, $, "get").then(function(G) {
                  return function(He, _e) {
                    var Ve = _e.query || {}, ir = _e.hash || {}, Me, wr, Ke = He.split("#");
                    wr = Ke[1];
                    var Y = (Me = Ke[0]).split("?");
                    Me = Y[0];
                    var Z = Fo(Y[1], Ve), W = Fo(wr, ir);
                    return Z && (Me = Me + "?" + Z), W && (Me = Me + "#" + W), Me;
                  }(Tt(fn()), {
                    query: G
                  });
                });
              }), $e = Ae.then(function(G) {
                return function(_e) {
                  var Ve = _e === void 0 ? {} : _e, ir = Ve.proxyWin, Me = Ve.initialChildDomain, wr = Ve.childDomainMatch, Ke = Ve.target, Y = Ke === void 0 ? window : Ke, Z = Ve.context;
                  return function(W) {
                  ...
                  return Ei({
                    name: w,
                    serializedPayload: _e
                  });
                });
                var He;
              }), ce = $e.then(function(G) {
                return nr(z, {
                  windowName: G
                });
              }), qe = _n(z), er = T.hash({
              ...
              }), vr = Je.then(function(G) {
                return se = G, rr(G);
              }), Or = T.hash({
                proxyPrerenderWin: an,
                state: vr
              }).then(function(G) {
                return _i(G.proxyPrerenderWin, {
                  context: z
                });
              }), Li = T.hash({
                proxyWin: Je,
                ...
                if (Be) return G.proxyWin.setName(G.windowName);
              }), is = T.hash({
                body: Le
              }).then(function(G) {
                ...
                (function He(_e, Ve) {
                  ...
                  return I.register(function() {
                    ...
                    if (!ir) {
                      if (Ve === Ce.POPUP && Me) return Wr(new Error("Detected popup close"));
                      var wr = !!(lr && dn(lr));
                      return Ve === Ce.IFRAME && Me && (wr || Ur) ? Wr(new Error("Detected iframe close")) : He(_e, Ve);
                    }
                  });
                })(G, z);
              }), ss = T.hash({
              ...
              }), us = Je.then(function(G) {
                return function(He, _e, Ve) {
                  return T.try(function() {
                    ...
                    if (jr && jr.needsBridge({
                      ...
                      var Me = typeof t.bridgeUrl == "function" ? t.bridgeUrl({
                        props: $
                      }) : t.bridgeUrl;
                      if (!Me) throw new Error("Bridge needed to render " + Ve);
                      var wr = xr(Me);
                      return jr.linkUrl(ir, _e), jr.openBridge(Tt(Me), wr);
                    }
                  });
                }(G, K, z);
              }), cs = ji.then(function() {
        ...
        register: function(e, n, t, o) {
          ...
          return function(c) {
            ...
            return f.render = function() {
              ...
              g.render(v, Ce.IFRAME), this.setState({
                parent: g
              });
        ...
        register: function(e, n, t) {
          return {
            ...
            mounted: function() {
              ...
              var a;
              this.parent.render(o, Ce.IFRAME);
            },
            watch: {
              $attrs: {
                handler: function() {
          ...
          return o.module(e, []).directive(Ct(e), function() {
            ...
            return a.props = "=", {
              ...
              controller: ["$scope", "$element", function(l, f) {
                ...
                w.render(f[0], Ce.IFRAME), l.$watch(function() {
        ...
        register: function(e, n, t, o) {
          var a = o.Component, u = o.NgModule, c = o.ElementRef, l = o.NgZone, f = o.Inject, v = function() {
            ...
            return p.getProps = function() {
              ...
              this.parent = t(this.getProps()), this.parent.render(m, Ce.IFRAME);
      ...
      function rs(e) {
        var n = function(y) {
          var P = y.tag, O = y.url, N = y.domain, M = y.bridgeUrl, V = y.props, I = V === void 0 ? {} : V, B = y.dimensions, F = B === void 0 ? {} : B, Q = y.autoResize, U = Q === void 0 ? {} : Q, ue = y.allowedParentDomains, ne = ue === void 0 ? "*" : ue, J = y.attributes, $ = J === void 0 ? {} : J, se = y.defaultContext, X = se === void 0 ? Ce.IFRAME : se, Ne = y.containerTemplate, Sr = Ne === void 0 ? ka : Ne, lr = y.prerenderTemplate, Ur = lr === void 0 ? es : lr, Br = y.validate, Nr = y.eligible, $r = Nr === void 0 ? function() {
            return {
              eligible: !0
            };
            ...
            window: {
              ...
              validate: function(te) {
                ...
                if (Qr(hr)) {
                  if (De(hr)) throw new Error("Window is closed");
          ...
          return {
            ...
            exports: typeof gr == "function" ? gr : function(te) {
              for (var hr = te.getExports, ae = {}, je = function() {
                var Re = Ue[Ie], Xe = gr[Re].type, Fe = hr().then(function(ze) {
                  return ze[Re];
                });
              ...
              }, Ie = 0, Ue = Object.keys(gr); Ie < Ue.length; Ie++) je();
              return ae;
            }
          };
          ...
          if (function(P) {
            ...
            var y = bi().payload;
            if (y.tag === o && ur(y.childDomainMatch, q())) return !0;
          }
          return !1;
        }, p = zr(function() {
          if (w()) {
            ...
            var y = function(P) {
              var O = P.tag, N = P.propsDef, M = P.autoResize, V = P.allowedParentDomains, I = [], B = bi(), F = B.parent, Q = B.payload, U = F.win, ue = F.domain, ne, J = new T(), $ = Q.version, se = Q.uid, X = Q.exports, Ne = Q.context, Sr = Q.props;
              if (!function(ae, je) {
              ...
              var lr = X.show, Ur = X.hide, Br = X.close, Nr = X.onError, $r = X.checkClose, qr = X.export, en = X.resize, Hr = X.init, gr = function() {
                ...
                var je = (ae === void 0 ? {} : ae).anyParent, Ie = [], Ue = ne.parent;
              ...
              return {
                init: function() {
                  return T.try(function() {
                    var ae = "";
                    return H(U) && (ae = function(je) {
                      var Ie = je.componentName, Ue = je.parentComponentWindow, Re = yi({
                      ...
                      if (!ur(je, Ie)) throw new Error("Can not be rendered by domain: " + Ie);
                    }(V, ue), Xo(U), function() {
                    ...
                    return (ae = M.width, je = ae !== void 0 && ae, Ie = M.height, Ue = Ie !== void 0 && Ie, Re = M.element, zo(Re === void 0 ? "body" : Re).catch(be).then(function(Xe) {
                      return {
                        width: je,
                        height: Ue,
                        element: Xe
                      ...
                      pr && (Fe || ze) && Ne !== Ce.POPUP && $o(pr, function(rr) {
                        Gr({
          ...
          var O, N = "zoid-" + o + "-" + Qe(), M = P || {}, V = c({
            props: M
          }), I = V.eligible, B = V.reason, F = M.onDestroy;
            ...
            return T.try(function() {
              ...
              return function(X, Ne) {
                return T.try(function() {
                  ...
                  if (Ne) {
                    if (Ne !== Ce.IFRAME && Ne !== Ce.POPUP) throw new Error("Unrecognized context: " + Ne);
                    return Ne;
                  }
                  return a;
                });
              ...
              if (J = function(X, Ne) {
                if (Ne) {
                  if (typeof Ne != "string" && !St(Ne)) throw new TypeError("Expected string or element selector to be passed");
                  return Ne;
                }
                if (X === Ce.POPUP) return "body";
      ...
      var ns = function(e) {
        (function() {
          Tr().initialized || (Tr().initialized = !0, u = (a = {
            on: Dr,
            send: mr
          }).on, c = a.send, (l = Tr()).receiveMessage = l.receiveMessage || function(f) {
            return Jt(f, {
              on: u,
              send: c
            });
...
function tc({ video: r, adContainer: i, trackingUrl: s, interval: d, startSession: h }) {
  ...
  function E({ icons: ge }) {
    return {
      id: L,
      appConfig: {
        sdkBaseUrl: ho("https://cdn.jsdelivr.net/gh/sigmaott/sigma-ssai-web-sdk/v4/build/dist/wta/index.html", { id: L })
      },
      icons: ge
    };
  }
  ...
  D.render(i), D.hide(), i.style.display = "none", xu(() => {
    var ge;
    if (_.value) {
      const re = ((ge = _.value) == null ? void 0 : ge.icons) || [];
  ...
  async function Ze(ge) {
    var ie;
    const re = (ie = _.value) == null ? void 0 : ie.trackingEvents.find((xe) => xe.eventType === ge);
    re && (x.trigger(re), await Promise.all(re.beaconUrls.map((xe) => Kr(Un(xe)))));
  }
  function T() {
    return S.value = !1, ["fullscreenchange", "webkitfullscreenchange", "mozfullscreenchange", "msfullscreenchange"].forEach((ge) => {
      ...
      if (oe.value = re.frag.sn, !ge !== window.Hls.Events.FRAG_CHANGED) {
        for (const ie of A.value)
          if (ie.sn === re.frag.sn)
            for (const Ee of Oe.value) {
              ...
              const q = Ee.trackingEvents.find((H) => H.eventType === ie.value.event);
              q && gu(async () => {
                ...
                x.trigger(q), await Promise.all(q.beaconUrls.map((H) => Kr(Un(H)))), ie.value.event === "complete" && (_.value = void 0, A.value = [], Ee.tracked = !0);
              }, ie.time * 1e3);
            }
      }
    };
  ...
  function br() {
    Kr(sa(b.value)).then(({ data: ge, error: re }) => {
      if (re) {
        console.error("Cannot get tracking data", re);
        return;
      }
      for (const ie of (ge == null ? void 0 : ge.avails) || [])
        for (const xe of ie.ads) {
          const Ee = `${ie.id}_${xe.id}_${xe.startTimeInSeconds}`;
          Oe.value.find((H) => H.key === Ee) || Oe.value.push({
            ...xe,
            key: Ee,
            tracked: !1
          });
  ...
  function _r() {
    return async (ge, re) => {
      ...
      const { start: xe, sn: Ee } = re.frag;
      for (let q = 0; q < re.samples.length; q++) {
        const H = re.samples[q], ye = H.data, Gn = H.pts;
        if (String.fromCharCode.apply(null, ye.slice(0, 3)) !== "ID3" || String.fromCharCode.apply(null, ye.slice(10, 14)) !== "TXXX")
          continue;
        const Pr = ye.slice(21, ye.length), Mr = ie(Pr), Fr = Pr.slice(Mr + 1, Pr.length), Sn = ie(Fr), De = new TextDecoder("utf-8").decode(Fr.slice(0, Sn)), On = {
          sn: Ee,
          time: Gn - xe,
          value: io(De)
        };
  ...
  function me() {
    return (ge) => {
      ...
      re.kind === "metadata" && (br(), re.on("cuechange", async () => {
        ...
        if (ie && ie.value.data) {
          const xe = io(ie.value.data);
          for (const Ee of Oe.value) {
            if (Ee.tracked)
              continue;
            _.value = Ee, h(Ee.adVerifications, x);
            const q = Ee.trackingEvents.find((H) => H.eventType === xe.event);
            if (q) {
              if (xe.event === "start") {
                const H = Ee.trackingEvents.find((ye) => ye.eventType === "impression");
                H && (x.trigger(H), await Promise.all(H.beaconUrls.map((ye) => Kr(Un(ye)))));
              }
              x.trigger(q), await Promise.all(q.beaconUrls.map((H) => Kr(Un(H)))), xe.event === "complete" && (_.value = void 0);
            }
          }
        }
      }));
  ...
  return {
    ...
    videojsHelper: {
      createVideojsAddTrack: me
    }
  };
}
async function oc({ video: r, adContainer: i, url: s }) {
  const d = await ms().catch((me) => null);
  async function h({ url: me }) {
    const ke = oa(me);
    async function Rr() {
      return d ? await gs(d, r) : null;
    }
    const ge = await Rr(), re = `${ke.protocol}//${ke.host}`, { data: ie, error: xe } = await Kr(sa(ho(me, ge ? { "play_params.nonce": ge } : {})));
    if (xe || !ie)
      throw console.error(xe), new Error(xe);
    const Ee = `${re}${ie.manifestUrl}`, q = `${re}${ie.trackingUrl}`;
    return {
      manifestUrl: Ee,
      trackingUrl: q
    };
  ...
  function Oe(me) {
    A.value = me;
    const ke = D.createHlsFragChanged(), Rr = D.createHlsFragParsingMetadata();
    me.on("hlsFragChanged", ke), me.on("hlsFragParsingMetadata", Rr), oe.value = () => {
      me.off("hlsFragChanged", ke), me.off("hlsFragParsingMetadata", Rr);
    };
  }
  const Ze = ar(), T = ar();
  function br(me) {
    ...
    me.textTracks().on("addtrack", ke), T.value = () => {
      me.textTracks().off("addtrack", ke);
    };
  }
  function _r() {
    var me, ke;
    L(), (me = oe.value) == null || me.call(oe), (ke = T.value) == null || ke.call(T);
  }
  return {
    manifestUrl: b,
    onEventTracking: _,
