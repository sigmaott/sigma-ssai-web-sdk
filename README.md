...
```html
<script src="https://cdn.jsdelivr.net/gh/sigmaott/sigma-ssai-web-sdk@1.1.0/build/sdk-dai.iife.js"></script>
```
...
[Download SDK](https://github.com/sigmaott/sigma-ssai-web-sdk/releases/tag/v1.1.0)
